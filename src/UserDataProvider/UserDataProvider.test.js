...
import { context } from "../data/fixtures";
...
const getProviderWithContext = (context = {selectedUser: '', userIsSelected: false, userData: userData}) => {
  ...
  return require('./UserData').UserDataProvider;
};
